...
-- that main module needs too much and needs to be split up or refactored

--- EventHorizon2 imports
local debug = EHZ.debug
local spellIDsEnabled = EHZ.spellIDsEnabled -- Toggles display of spellIDs in tooltips. Useful for working on spell configs
local class = EHZ.class
local playerName = EHZ.playerMame
local vars = EHZ.vars
local drawOrder = EHZ.drawOrder

local spellFrame = EHZ.SpellFrame
local EventHorizonFrame = EHZ.EventHorizonFrame
local mainFrame = EHZ.mainFrame
local frame = EHZ.frame
local frame2 = EHZ.frame2
local frame3 = EHZ.frame3
local auraids = EHZ.auraids
local exemptColors = EHZ.exemptColors
local equipSlots = EHZ.equipSlots
